                ...
                <div class="info">
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="heading text-center">
                            ...
                            <p class="heading-text">This is my porfolio of work I have completed and examples of the work I plan to take on next year. <br>
                ...
                <div class="contacts">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                            <a href="#" class="title" style="size:14px;">{{$settings->contact_email}}</a>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                ...
                                <p class="sub-title">52, SO45 2PF</p>
                            </div>
                        </div>
                    </div>
                </div>
